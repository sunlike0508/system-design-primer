...
- [시스템 설계 입문서](#%ec%8b%9c%ec%8a%a4%ed%85%9c-%ec%84%a4%ea%b3%84-%ec%9e%85%eb%ac%b8%ec%84%9c)
  - [동기 부여 및 목적](#%eb%8f%99%ea%b8%b0-%eb%b6%80%ec%97%ac-%eb%b0%8f-%eb%aa%a9%ec%a0%81)
    - [대규모 시스템 설계 방법 알아보기](#%eb%8c%80%ea%b7%9c%eb%aa%a8-%ec%8b%9c%ec%8a%a4%ed%85%9c-%ec%84%a4%ea%b3%84-%eb%b0%a9%eb%b2%95-%ec%95%8c%ec%95%84%eb%b3%b4%ea%b8%b0)
    - [오픈 소스 커뮤니티에서 배우기](#%ec%98%a4%ed%94%88-%ec%86%8c%ec%8a%a4-%ec%bb%a4%eb%ae%a4%eb%8b%88%ed%8b%b0%ec%97%90%ec%84%9c-%eb%b0%b0%ec%9a%b0%ea%b8%b0)
    - [시스템 설계 면접 준비](#%ec%8b%9c%ec%8a%a4%ed%85%9c-%ec%84%a4%ea%b3%84-%eb%a9%b4%ec%a0%91-%ec%a4%80%eb%b9%84)
  - [플래시 카드식 암기](#%ed%94%8c%eb%9e%98%ec%8b%9c-%ec%b9%b4%eb%93%9c%ec%8b%9d-%ec%95%94%ea%b8%b0)
  ...
  - [성능 vs 확장성](#%ec%84%b1%eb%8a%a5-vs-%ed%99%95%ec%9e%a5%ec%84%b1)
    - [더 읽을 거리](#%eb%8d%94-%ec%9d%bd%ec%9d%84-%ea%b1%b0%eb%a6%ac)
  - [지연시간 vs 처리량](#%ec%a7%80%ec%97%b0%ec%8b%9c%ea%b0%84-vs-%ec%b2%98%eb%a6%ac%eb%9f%89)
    - [더 읽을 거리](#%eb%8d%94-%ec%9d%bd%ec%9d%84-%ea%b1%b0%eb%a6%ac-1)
...
자원이 추가되는 것에 따라 **성능**이 향상될 경우, 그 서비스는 **확장**이 가능하다고 할 수 있습니다. 일반적으로 성능이 향상하는 것은 더 많은 작업을 처리할 수 있음을 의미하는데, 데이터 셋이 증가할 때와 같이 더 큰 작업 단위를 다룰 수 있다는 것입니다.<sup><a href=http://www.allthingsdistributed.com/2006/03/a_word_on_scalability.html>1</a></sup>

성능 vs 확장성을 보는 또 다른 관점:

* **성능** 문제가 있는 경우, 단일 사용자에 대해 시스템 속도가 느려집니다.
* **확장성**에 문제가 있는 경우, 시스템이 단일 사용자에 대해 속도가 빨라도, 부하가 많을 때는 느려집니다.
...
**지연시간**은 어떤 작업을 수행하거나 결과를 생성하는데 걸리는 시간 입니다.

**처리량**은 단위 시간당 처리 결과에 대한 개수 입니다.

일반적으로, 적당한 지연시간에 처리량을 최대로 하는 것을 목표로 해야 합니다.
